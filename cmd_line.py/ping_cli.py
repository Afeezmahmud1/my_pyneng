...
parser = argparse.ArgumentParser(description='Ping script Module')
parser.add_argument('host', metavar='ip',action="store",help = "IP or Name to ping")
parser.add_argument('-c','--c',action="store",dest='count', default=2, type=int,help ='Number or ping packet')
